...
setwd("~/MBA/RStudioProjects/Vienna_July24/Fall_2024/day1/scripts")
...
table(as.factor(dat$Class)) #identify nr of yes and no
# Prep and non prep
set.seed(2022)
...
downSampleFit <- train(Class ~ .,          #class e o functie de . (toate variabilele din dataset), in loc de . puteam avea age+job+education etc
                      data = treatedTrain,
                      method = "rf",
                      verbose = FALSE,
                      ntree = 3,
